...
//               hidden={user}
//               className="hidden md:block px-6 py-2 bg-green-500 hover:bg-green-700 rounded-full text-white"
//             >
//               Get started
//             </Link>
...
//               to="/app"
//               hidden={!user}
//               className="hidden md:block px-8 py-2 bg-green-500 hover:bg-green-700 rounded-full text-white"
//             >
//               Dashboard
//             </Link>
//           </div>
...
//         {/* Mobile Menu */}
//         <div className={`fixed inset-0 z-[100] bg-black/40 backdrop-blur flex flex-col items-center justify-center gap-8 md:hidden transition-transform ${menuOpen ? "translate-x-0" : "-translate-x-full"}`}>
//           <a href="#" className="text-white">Home</a>
//           <a href="#features" className="text-white">Features</a>
//           <a href="#testimonials" className="text-white">Testimonials</a>
//           <a href="#contact" className="text-white">Contact</a>
...
//         {/* Hero Section */}
//         <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
//           <div className="absolute top-28 -z-10 size-96 bg-green-300 blur-[100px] opacity-30"></div>
...
//             <button className="border border-slate-400 rounded-full px-7 h-12 text-slate-700">
//               Try demo
//             </button>
//           </div>
//         </div>
...
const Hero = () => {
  ...
  return (
    <>
      <div className="min-h-screen pb-20 bg-gradient-to-b from-blue-50 to-white">
        {/* NAVBAR */}
        <nav className="z-50 flex items-center justify-between w-full py-5 px-6 md:px-16 lg:px-24 xl:px-40">
          {/* Logo */}
          <div className="font-extrabold text-2xl text-blue-600 tracking-wide">
            Resume Builder
          </div>
          ...
          <div className="hidden md:flex gap-3">
            {!user && (
              <>
                <Link
                  to="/app?state=login"
                  className="px-6 py-2 rounded-full border border-blue-300 text-blue-700 hover:bg-blue-50 transition"
                >
                  Login
                </Link>
            ...
            {user && (
              <Link
                ...
                className="px-8 py-2 rounded-full text-white
                  ...
                  shadow-lg shadow-blue-500/30 hover:-translate-y-0.5 transition-all"
              >
                Dashboard
              </Link>
            )}
        ...
        {/* HERO SECTION */}
        <section className="relative flex flex-col items-center justify-center px-6 md:px-16 lg:px-24 xl:px-40 text-center text-slate-900">
          {/* Glow */}
          <div className="absolute top-32 -z-10 size-96 bg-blue-300 blur-[140px] opacity-30"></div>

          {/* Rating */}
          <div className="flex mt-24 gap-1">
            {Array(5).fill(0).map((_, i) => (
          ...
          <p className="text-sm text-slate-600 mt-2">
            NO HIDDEN CHARGES AFTER CREATING RESUMES <br />
            PDF FORMAT SUPPORTED
          </p>

          {/* Headline */}
          <h1 className="mt-6 text-5xl md:text-6xl font-extrabold max-w-5xl leading-tight">
            Create your free
            <span className="block bg-gradient-to-r from-blue-600 to-blue-400 bg-clip-text text-transparent">
              AI-built, ATS-friendly resumes
            </span>
          </h1>

          {/* Subtitle */}
          <p className="max-w-md mt-6 text-base text-slate-600">
        Get noticed by recruiters with  Create free AI resumes that are ATS-approved and land more interviews
          </p>
  ...
  <Link
    to="/app"
    className="
      px-12 h-14 flex items-center justify-center
      rounded-full text-white text-lg font-medium
      bg-gradient-to-r from-blue-900 via-blue-800 to-blue-700
      shadow-xl shadow-blue-900/40
      hover:shadow-blue-900/60 hover:-translate-y-1
  ...
  >
    Create Free Resume
            ...
            {/* <button
              className="
                px-10 h-14 rounded-full text-blue-700 text-base
                border border-blue-300 bg-white/70 backdrop-blur
