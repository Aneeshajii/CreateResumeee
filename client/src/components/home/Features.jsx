...
//     <div id='features' className='flex flex-col items-center my-10 scroll-mt-12 margin=0'>
//  {/* <div><h1>Step By Step Guide </h1></div> */}
...
//             <div className="px-24 flex flex-col md:flex-row items-center xl:-mt-10">
...
//                 <div className="px-24 md:px-0" onMouseEnter={() => setIsHover(true)} onMouseLeave={() => setIsHover(false)}>
...
//                                 <h3 className="text-base font-semibold text-slate-700">Step by Step Guide</h3>
...
const steps = [
  {
    ...
    description:
      "Create a free account or log in to get started with our AI resume builder.",
  },
  {
    step: "02",
    title: "Create or Upload Resume",
    description:
      "Start a new resume from scratch or upload your existing resume to improve it.",
  },
  {
    step: "03",
    title: "Build & Download",
    description:
      "Add your details, photo, Try different colors and templates, then download your ATS-approved resume as a PDF — 100% free.",
  },
];
    ...
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-b from-blue-50 to-white px-4">
      <div className="max-w-5xl w-full text-center">
        ...
        <p className="mt-3 text-slate-600 text-sm md:text-base max-w-xl mx-auto">
          Build a professional, ATS-friendly resume in just a few simple steps.
        </p>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          {steps.map((item) => (
            <div
              ...
              "
            >
              <div className="flex items-center justify-center w-12 h-12 rounded-full bg-blue-600 text-white font-semibold mx-auto">
                {item.step}
              </div>
